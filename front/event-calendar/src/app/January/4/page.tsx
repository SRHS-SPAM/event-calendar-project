  ...
  return (
    <div className="h-[100vh] w-[100vw]">
      ...
      <div className="h-full w-full flex justify-center items-center">
        ...
        <div className="h-[40%] w-[14%] absolute inset-0 -z-5 mr-[86%] mt-[22%]">
            <img
              src="/bingcandy.png" //이미지
              alt="Background"
              className="w-full h-full"
            />
        </div>
        <div className="h-[50%] w-[30%] absolute inset-0 -z-1 ml-[64%] mt-[25%]">
            <img
              src="/bnigs.png" //이미지
              alt="Background"
              className="w-full h-full"
        ...
        <div className="h-auto w-[42%] absolute inset-0 -z-10 ml-[2%] mt-[27%]">
            <img
              src="/bingman.png" //이미지
              alt="Background"
              className="w-full h-full"
